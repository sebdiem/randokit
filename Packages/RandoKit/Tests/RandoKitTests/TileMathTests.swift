...
struct TileMathTests {
    ...
    @Test func corridorContainsEveryPointTile() {
        ...
        let tiles = TileMath.corridorTiles(around: points, bufferMeters: 500, zooms: 10...14)
        for zoom in 10...14 {
            for point in points {
    ...
    @Test func corridorIsSmallerThanBoundingBoxForLShapedTrace() {
        ...
        let corridor = TileMath.corridorTiles(around: points, bufferMeters: 300, zooms: 14...14)
